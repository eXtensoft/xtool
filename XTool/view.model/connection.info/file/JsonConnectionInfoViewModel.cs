// <copyright file="JsonConnectionInfoViewModel.cs" company="eXtensible Solutions LLC">
...
using System.Windows.Input;
    ...
    public sealed class JsonConnectionInfoViewModel : ConnectionInfoViewModel
    {
        public new JsonConnectionInfo Model { get; set; }
        ...
        public JsonConnectionInfoViewModel(JsonConnectionInfo model)
        {
            Model = model;
            base.Model = model;
        }
        ...
        private void OpenFile()
        {
            ...
            dialog.Filter = String.Format("Json Files|*.txt;*.json");
